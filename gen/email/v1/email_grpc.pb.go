...
func (c *emailServiceClient) SendTemplateEmail(ctx context.Context, in *SendTemplateEmailRequest, opts ...grpc.CallOption) (*SendTemplateEmailResponse, error) {
	out := new(SendTemplateEmailResponse)
	err := c.cc.Invoke(ctx, "/email.v1.EmailService/SendTemplateEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEmailServiceServer) SendTemplateEmail(context.Context, *SendTemplateEmailRequest) (*SendTemplateEmailResponse, error) {
...
func _EmailService_SendTemplateEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/email.v1.EmailService/SendTemplateEmail",
	}
